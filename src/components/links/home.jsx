  ...
  return (
    <React.Fragment>
      ...
      <p style={{ paddingLeft: "2rem", paddingBottom: "2rem" }}>
        A BEAUTIFUL, RESPONSIVE, STATICALLY-GENERATED, REACT APPLICATION WRITTEN
      ...
      <div>
        <p style={{ padding: "2rem" }}>
          ...
          , view site{" "}
          <Link to="/Stats" className={styles.links}>
            Statistics
          </Link>
          , or{" "}
        ...
        <h5 style={{ padding: "2rem" }}>
          Source Available This Link:{" "}
          <a
            style={{ color: "black", margin: "5px" }}
            href="https://github.com/shahmali7/Personal-site-with-react"
          >
            Personal-site
          </a>
        </h5>
